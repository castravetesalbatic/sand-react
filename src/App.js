        ...
        <View style={styles.app}>
          <View>
            ...
            <form id="form">
              ...
              <br />
              <br />
              <input text="text" placeholder="Last Name" style={styles.text1} />
              <br />
              <br />
              <input
                text="number"
              ...
              <br />
              <br />
              <input text="email" placeholder="E-mail" style={styles.text1} />
              <br />
              <br />
              <input
                text="password"
          ...
          <button class="button button1" onPress={() => {}} title="Create">
            Create
          </button>
          <br />
          <button class="button button2" onPress={() => {}}>
            I'm a NGO
          </button>
          <br />
        </View>
